...
- Project sync preserves an existing project binding's current `IRANTI_AGENT_ID`, `IRANTI_MEMORY_ENTITY`, `IRANTI_PERSONAL_MEMORY_ENTITY`, and `IRANTI_AUTO_REMEMBER` unless the user overrides them elsewhere.
