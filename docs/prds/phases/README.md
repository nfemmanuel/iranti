...
| [Layer 0e — Checkpoint Criteria & Project-State Rollup](layer-0e-checkpoints.md) | Layer 0e (YC foundation) | shipped |

| [Layer 0f — No-Answer Honesty](layer-0f-no-answer.md) | Layer 0f (YC foundation) | accepted |
