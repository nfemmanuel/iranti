...
- Iranti is model/agent agnostic. It works identically regardless of the host (Claude, Codex, Copilot) and regardless of the model it runs on (Anthropic, OpenAI, etc.)
