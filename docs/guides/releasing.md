...
Current repo version is `0.2.27`. If the next release is `0.2.28`, use the following exact sequence.

1. Bump versions in one step:

```bash
npm run release:bump -- 0.2.28
```
