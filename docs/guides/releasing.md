...
Current repo version is `0.3.0`. If the next release is `0.3.1`, use the following exact sequence.
...
gh release create v0.3.1 --title "v0.3.1" --notes "Release notes here"
```
